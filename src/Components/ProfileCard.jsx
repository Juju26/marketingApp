...
import profile from "../assets/imgs/profile-thumbnail.png";
      ...
      <div className="card-container">
        <div className="card">
          <div className="card-profile">
            <img className="card-profilePic" src={profile} alt="no img"></img>
            <div className="card-profileDetails">
              <p className="card-profileName">Sarah Dole</p>
              <p className="card-jobTitle">Front End Engineer @ Microsoft</p>
              <p className="card-profileDescription">
                I turn coffee into bugs which are fixed by someone else.
                Certified Stack Overflow and ChatGPT developer.
              </p>
            </div>
            <button className="card-contactMe">Contact me</button>
            <div className="flex gap-8 card-socialProfiles">
              {/* <!-- Github --> */}
              <a href="#">
